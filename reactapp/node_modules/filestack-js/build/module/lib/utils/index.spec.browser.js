...
describe('utils:index', function () {
    describe('getVersion', function () {
        it('should return version string to replace', function () {
            expect(utils.getVersion()).toEqual("JS-3.12.4");
        });
    });
